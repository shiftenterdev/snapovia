...
@section('content')
    ...
    <div class="content">
        <div class="container-fluid">
            <form action="{{route('admin.cms-page.create')}}" method="post" autocomplete="off"
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header p-0 d-flex bg-gradient-info">
                                <h3 class="card-title p-3"><strong>New Cms Page</strong></h3>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="content_heading" class="form-control form-control-sm"
                                                   placeholder="Content Heading" required>
                                        </div>
                                    </div>
