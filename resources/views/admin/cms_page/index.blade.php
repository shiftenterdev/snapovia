...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Cms Page</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <a href="{{route('admin.cms-page.create')}}" class="btn btn-outline-danger btn-sm">
                                ...
                                @foreach($pages as $key => $c)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{route('admin.cms-page.delete',$c->id)}}" class="text-muted">
