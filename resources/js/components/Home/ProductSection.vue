        ...
        <div class="container">
            ...
            <div class="tab-content">
                <div class="tab-pane fade show active" id="womenTab">
                    <div class="row">
                        <div v-if="womensProduct.length" v-for="product in womensProduct"
                ...
                <div class="tab-pane fade show" id="menTab">
                    <div class="row">
                        <div v-if="mensProduct.length" v-for="product in mensProduct" class="col-6 col-md-4 col-lg-3">
                            <div class="card mb-7">
                                <div class="badge badge-white card-badge card-badge-left text-uppercase">
                                    New
                                </div>
                ...
                <div class="tab-pane fade show" id="gadgetTab">
                    <div class="row">
                        <div v-if="otherProducts.length" v-for="product in otherProducts" class="col-6 col-md-4 col-lg-3">
                            <!-- Card -->
                            <div class="card mb-7">
                                <!-- Badge -->
                                <div class="badge badge-white card-badge card-badge-left text-uppercase">
