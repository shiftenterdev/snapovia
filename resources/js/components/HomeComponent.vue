            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-3 col-lg-3 col-sm-4 col-xs-12 float-right-style">
                        <left-menu-section></left-menu-section>
                    </div>
                    <!-- End Left Feature -->
                </div>
            </div>
...
<script>
    import  BlogSection from "./home/section/Blog";
    import  SliderSection from "./home/section/Slider";
    import  LeftMenuSection from "./home/section/LeftMenu";
    import  ProductSection from "./home/section/Product";
    import  SearchSection from "./common/section/Search";
    export default {
        components:{
            BlogSection,
            SliderSection,
